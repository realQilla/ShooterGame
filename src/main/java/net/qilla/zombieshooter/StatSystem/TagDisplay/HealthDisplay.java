package net.qilla.zombieshooter.StatSystem.TagDisplay;

import net.kyori.adventure.text.minimessage.MiniMessage;
import net.qilla.zombieshooter.StatSystem.EntityKey;
import net.qilla.zombieshooter.StatSystem.HealthCalculation.HealthDifference;
...
public class HealthDisplay {
    ...
    public void initialDisplaySetup() {
        ...
        entity.setMetadata(String.valueOf(EntityKey.MODIFIED_ENTITY), new FixedMetadataValue(ZombieShooter.getInstance(), true));
    }
    ...
    public void updateHealthDisplay() {
        ...
        if(type == DisplayType.HEAL) {
            ...
            }.runTaskLater(ZombieShooter.getInstance(), 10);
            return;
        }
