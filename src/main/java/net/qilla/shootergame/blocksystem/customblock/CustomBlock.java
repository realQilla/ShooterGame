...
public enum CustomBlock {
    ...
    WOODEN_PLANKS(3,
            ...
            1,
            1,
            List.of(Material.WOODEN_AXE, Material.STONE_AXE, Material.IRON_AXE, Material.DIAMOND_AXE, Material.NETHERITE_AXE, Material.GOLDEN_AXE)),
    CRACKED_STONE(4,
            ...
            1,
            3,
            List.of(Material.WOODEN_PICKAXE, Material.STONE_PICKAXE, Material.IRON_PICKAXE, Material.DIAMOND_PICKAXE, Material.NETHERITE_PICKAXE, Material.GOLDEN_PICKAXE)),
    COBBLESTONE_NODE(5,
            Material.COBBLESTONE,
            Material.TUFF,
            new NodeBlock(12),
